...
{#if animate}
	<main class="container flex flex-col gap-y-32" in:fly={flyOptions}>
		<section class="relative overflow-hidden">
			<div class="mx-auto mb-16 mt-40 flex max-w-2xl flex-col items-center gap-6 text-center">
				<h1
				...
				<div class="inline-flex items-center gap-2 text-left">
					<span class="text-sm font-medium"
						...
						<a class="underline hover:text-primary" href="https://www.linkedin.com/in/aljon-lerios/"
							>Aljon Lerios</a
						>.
					</span>
				</div>
			...
			<div class="relative">
				...
				>
					<div class="absolute left-0 top-0 grid h-full w-full grid-cols-8 gap-6 md:grid-cols-12">
						<div
							class="col-span-6 col-start-2 min-w-[40rem] overflow-hidden rounded-lg border shadow-sm sm:col-start-3 sm:min-w-[48rem] md:col-span-8 md:mb-12 md:min-w-0"
						>
					...
					<div class="absolute left-0 top-0 grid h-full w-full grid-cols-8 gap-6 md:grid-cols-12">
						<div
							class="col-span-6 col-start-1 mt-52 min-w-[40rem] overflow-hidden rounded-lg border shadow-sm sm:col-start-2 sm:min-w-[48rem] md:col-span-8 md:col-start-5 md:mt-12 md:min-w-0"
						>
		...
		<div class="w-full">
			<div class="mx-auto max-w-xl py-8 text-center">
				<p class="mb-4 text-base md:text-lg">Made for CS Students of</p>
				<div
				...
				<div class="relative">
					...
					<dl class="mt-10 space-y-10">
						<div class="relative">
							<dt>
								<div
									class="absolute flex size-12 items-center justify-center rounded-md bg-primary text-primary-foreground"
								>
									<Check class="size-6" />
								</div>
								<p class="ml-16 font-semibold leading-6">User Friendly Interface</p>
							</dt>
							<dd class="ml-16 mt-1 text-sm">An environment that mimics real-life.</dd>
						</div>
						...
						<div class="relative">
							...
							<dd class="ml-16 mt-1 text-sm">Receive relevant improvement tips.</dd>
						</div>
						...
						<div class="relative">
							...
							<dd class="ml-16 mt-1 text-sm">Monitor your performance over time.</dd>
						</div>
					</dl>
				</div>

				<div class="relative mt-12 lg:mt-0" aria-hidden="true">
			...
			<div class="relative mt-12 sm:mt-16 lg:mt-24">
				<div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:items-center lg:gap-12">
					<div class="lg:col-start-2">
						<h3 class="text-3xl font-semibold">Integrated Speech Assessment</h3>
						<p class="mt-3">
							Practice is the key to success. We’ve designed the practice process to be as simple as
