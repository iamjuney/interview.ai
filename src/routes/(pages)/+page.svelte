<script lang="ts">
	import { Button, Header, Footer } from '$lib/components';
				...
				>
					<div>
						...
						<p class="text-base md:text-lg">
							Practice CS/IT related job interview scenarios and get instant transcriptions and
							feedback. Your practice, your privacy.
						</p>
					</div>
