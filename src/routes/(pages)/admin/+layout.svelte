<script lang="ts">
	import { Button, AdminDesktopSideBar, AdminMobileSideBar } from '$lib/components';
...
<AdminMobileSideBar bind:isOpen user={data.user} />

<!-- Static sidebar for desktop -->
<AdminDesktopSideBar user={data.user} />
